    ...
    inquirer.prompt([
        {
            type : 'confirm',
            name : 'cli',
            message : 'Will you use the module from the command line? (create bin/ dir)',
            default : false
        },
        {
            type : 'confirm',
            name : 'editorconfig',
            message : 'Add EditorConfig? [http://editorconfig.org]',
            default : true
        },
        {
            type : 'confirm',
            name : 'gitignore',
            message : 'Add node_modules to .gitignore to prevent versioning?',
            default : true
        },
        {
            type : 'list',
        ...
        var scaffoldOptions = answers;
        scaffoldOptions.moduleExists = fs.existsSync(modulePath);
        scaffold(modulePath, scaffoldOptions);
    });
};
